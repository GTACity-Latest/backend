...
async function injurePlayer(player, respawnTime) {
    ...
    mp.chat.info(player, `Yaralıya düştün, 911'i ara yoksa 15 dakikada içerisinde kan kaybından öleceksin!`)
...
async function respawnAtHospital(player) {
    ...
    player.stopAnimation();
    player.outputChatBox(`!{#ff73a9}Ölüm!{white} En yakın hastanede tedavi edildin. !{red}NLR kuralını unutma!{white} ölümünden 30 dakika öncesini hatırlayamazsın.`)
